...
const BirthCertificateDocument = () => {
    ...
    <div className="document-page">
      ...
      <div className="document-content">
        <div className="document-section">
          <h2>What is a Birth Certificate?</h2>
          <p>
            An official birth certificate for children, translated into Japanese
            and authenticated by your embassy. This proves the child's identity
            and age.
          </p>
        </div>
        ...
        <div className="document-section">
          ...
          <ul>
            ...
            <li>Include child's full name</li>
            <li>Show birth date and location</li>
          </ul>
        </div>
...
export default BirthCertificateDocument;
